# CLAUDE.md — Composed Agent Workflow (HO10)
...
## About this project
A composed agent workflow (Skill + Connector + MCP).
**Primary way to do it:** Claude.ai (assemble the Skill + Connectors + MCP) — **no API key needed.**
...
- It's the **Composed Agent Workflow** hands-on. Subscription-native — no API key.
